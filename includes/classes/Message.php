...
{ 
    ...
    public function getMessages($otherUser)
    {
        ...
        $get_message_query = mysqli_query($this->conn , "SELECT * FROM messages WHERE (user_to='$userLoggedIn' AND user_from='$otherUser') OR (user_from='$userLoggedIn' AND user_to='$otherUser')") ;
        ...
        foreach($convos as $username){
            ...
            $return_string .= "<a href='messages.php?u=$username'> 
                                    <div class='user_found_messages'>
                                        <img src='" . $user_found_obj->getPorfilePic() . "' style='border-radius: 5px; margin-right: 5px;'>
    ...
    public function getConvosDropdown($data, $limit)
    {
        ...
        foreach($convos as $username){
            ...
            $is_unread_query = mysqli_query($this->conn, "SELECT opened FROM messages WHERE (user_to='$userLoggedIn' AND user_from='$username') OR (user_to='$username' AND user_from='$userLoggedIn') ORDER BY id DESC");
