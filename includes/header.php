...
<html>
    <head>
        ...
        <!-- CSS -->
        <script src="https://use.fontawesome.com/363f66e065.js"></script>
        ...
        <div class="top_bar">
            ...
            <div class="search">
                ...
                <form action="search.php" method="GET" name="search_form">
                    ...
                    <input type="text" onkeyup="getLiveSearchUsers(this.value, '<?php echo $userLoggedIn; ?>')" name="q" id="search_text_input" placeholder="Search..." autocomplete="off">
            ...
            <nav>
                <?php 
                    ...
                    // Unread Requests 
                    $requests = new User($conn, $userLoggedIn);
                    $num_requests = $requests->getNumberOfFriendRequests();
                ?>
