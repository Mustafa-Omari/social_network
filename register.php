            ...
            <div class="login_box">
                ...
                <div id="first">
                    ...
                    <form action="register.php" method="POST">
                        ...
                        <a href="#" class="signup" id="signup">Need and account? Register here!</a>
                ...
                <div id="second">
                    ...
                    <form action="register.php" method="POST">
                        ...
                        <br>
                        <?php 
                            if(in_array("Your Email is already used<br>" , $error_array))
                                echo "Your Email is already used<br>";
                            elseif(in_array("Invalid Email format<br>" , $error_array))
                                echo "Invalid Email format<br>";
                            elseif(in_array("Your Emails don't match<br>", $error_array))
                                echo "Your Emails don't match<br>";
                        ?>
                        ...
                        <br>
                        <?php 
                            if(in_array("Your passwords don't match<br>",$error_array))
                        ...
                        <a href="#" class="sginin" id="signin">Already have an account? Sign in here!</a>
